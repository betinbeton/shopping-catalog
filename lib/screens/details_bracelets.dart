...
class DetailsBraceletsScreen extends StatelessWidget {
  const DetailsBraceletsScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final Bracelet data = ModalRoute.of(context)!.settings.arguments! as Bracelet;
          ...
          children: [
            Container(
              ...
              child: Swiper(
                ...
                //TODO ver el tamanio hacer pruebas
