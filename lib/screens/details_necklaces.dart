...
class DetailsNecklacesScreen extends StatelessWidget {
  const DetailsNecklacesScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final Necklace data = ModalRoute.of(context)!.settings.arguments! as Necklace;
